...
<body>
	...
	<div class="horizontal-menu">
		...
		<form action="save_pasien.php" method="post">
			...
			<input type="text" name="id_pasien" class="form_login" placeholder="Identitas Pasien.." required="required">
			...
			<input type="text" name="nktp_pasien" class="form_login" placeholder="Nomor HP Pasien .." required="required">
			
			<label>Nomor HP Pasien</label>
			<input type="text" name="nohp_pasien" class="form_login" placeholder="Nomor HP Pasien .." required="required">
