...
?>
		...
		<form action="update_pasien.php" method="post">			
			...
			<input type="hidden" name="id_pasien" class="form_login" placeholder="Identitas Pasien.." required="required" value="<?php echo $id_pasien;?>">
			...
			<label>Nomor KTP Pasien</label>
			<input type="text" name="nktp_pasien" class="form_login" placeholder="Nomor HP Pasien .." required="required" value="<?php echo $nktp_pasien;?>">
			
			<label>Nomor HP Pasien</label>
			<input type="text" name="nohp_pasien" class="form_login" placeholder="Nomor HP Pasien .." required="required" value="<?php echo $nohp_pasien;?>">
			
			<label>No Rekam Medis</label>
			<input type="text" name="norm_pasien" class="form_login" placeholder="No Rekam Medis .." required="required" value="<?php echo $norm_pasien;?>">
